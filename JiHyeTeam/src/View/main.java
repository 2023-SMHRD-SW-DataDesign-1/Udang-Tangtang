		...
		while (true) {
			...
			if (select == 0) {// 룰 설명
				...
				System.out.println("- 난이도별로 각각 10개의 문제가 출제된다.\r\n"
						...
						+"- 힌트 사용 시 주어진 점수의 절반을 획득한다.\r\n"
						+ "- 노래의 전주가 60초 동안 흘러나온다.\r\n"
						+ "- 노래제목을 맞췄을 경우, 점수를 획득하고 다음 노래로 넘어간다.\r\n"
						+ "- 노래제목을 맞추기 못했을 경우: \r\n"
						+ "  [1]힌트보기를 선택시\r\n"
						+ "  >> 가수명과 제목의 초성이 뜨고 한번 더 입력할 수 있다.\r\n"
						+ "  [2]다음노래로 패스를 선택시\r\n"
						+ "  >>다음노래로 넘어간다.\r\n"
						+ "- 난이도별로 기회의 개수가 다르게 주어진다.\r\n"
						+ "- Easy는 5번, Normal은 4번, Hard는 3번의 기회가 주어진다\r\n"
						+ "- 주어진 기회를 다 사용하거나 문제가 다 출제되면 게임이 종료된다.\r\n"
						+ "");
				System.out.println();
